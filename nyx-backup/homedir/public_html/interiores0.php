	<section id="contenido">
				<section id="principal-productos">
					...
					while($registro=$ejecutar_consulta->fetch_assoc()){
							  ...
							  echo "<a href='?op=descripcion_producto&item=".($item_nro)."'><img src='img/imgproductos/interiores/".$registro["image1"]."'align='middle'  width='200' height='120' /></a>";
