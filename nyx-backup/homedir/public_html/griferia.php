							...
							//	echo "<h3>Descripcion ".$registro['descripcion']."</h3>";
								...
								echo "<hr id='linea-producto'>";
										...
										echo "<div id='paginador'>";
										 if($nro_pagina>1)
											echo "<a href='?op=griferia&num=".($nro_pagina-1)."'><img class='anterior'src='img/gif/arrow-left.gif' /></a>";
											for($i=1;$i<=$can_paginas;$i++){
												if($i==$nro_pagina)
												echo "<p style='font-size:1.3em;'>$i|</p> ";
												else
												echo "<a href='?op=griferia&num=$i'> $i </a>";
											}
										if($nro_pagina<$can_paginas)
										echo "<a href='?op=griferia&num=".($nro_pagina+1)."'><img class='siguiente' src='img/gif/arrow-right.gif'/></a>";
										echo "</div>";
					?>
